...
def test_count_tokens_simple_text():
    ...
    # Act
    result = TokenizerService.count_tokens(text)
...
def test_count_tokens_different_model():
    ...
    # Act
    result = TokenizerService.count_tokens(text, model)
...
def test_estimate_tokens_from_characters():
    ...
    # Act
    result = TokenizerService.estimate_tokens_from_characters(char_count)
